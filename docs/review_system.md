...
## Cross-Batch Adjudication Packages

When two extraction batches should be compared directly, create a named
adjudication round. V1 supports exactly two batch JSONLs:

```bash
oncai adjudication create ihc_compare_v1 \
    --definition path_kidney_ihc \
    --left inbox/fc_extractions/ihc_gpt5_v1/001.jsonl \
    --right inbox/fc_extractions/ihc_gemma_v1/001.jsonl \
    --left-label gpt5 \
    --right-label gemma
```
...
```text
inbox/fc_adjudications/ihc_compare_v1/adjudication.json
inbox/fc_adjudications/ihc_compare_v1/ihc_compare_v1.adjudication_pkg.json
```
