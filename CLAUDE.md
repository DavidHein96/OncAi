...
The following words **must not appear anywhere** in the codebase, docs, or
tests: `beaker`, `copath`, `legacy ai`, `templater`. These were
institution-specific names from the pre-open-source version. If you see one
during a search, it's a regression — remove it.
